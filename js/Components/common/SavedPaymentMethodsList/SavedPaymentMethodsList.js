...
import { Button, Placeholder, Panel } from "../../common";
import cardBrands from "../../../constants/creditCardBrands";


const SavedPaymentMethod = ({ card_brand, customer_name, last4, is_default }) => {
